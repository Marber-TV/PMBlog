...
async function lstArticulos() {
    ...
    let lstTabla = "<div class='container-fluid'><div class='row'><div class='col-12 table-responsive'><table class='table bg-light table-striped'>";
...
async function buscarID() {
    ...
    if (respuesta.error) {
        ...
        if (respuesta.datos == null) {
            ...
            let tabla = "<div class='container-fluid'><div class='row'><div class='col-12 table-responsive'><table class='table bg-light table-striped'>";
